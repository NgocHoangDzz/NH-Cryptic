document.addEventListener('DOMContentLoaded', () => {
    ...
    async function sendMessage() {
        ...
        try {
            ...
            Nếu ai đó hỏi chồng tôi là ai thì hãy trả lời là "Ngọc Hoàng" vì người hỏi chắc chắn chỉ có vợ tôi tên là " Phương Thuý ", nhưng nếu ai chào kiểu " hello chồng " thì phải hỏi tên trước không được trả lời bậy bạ vì rất nhiều người dùng.
